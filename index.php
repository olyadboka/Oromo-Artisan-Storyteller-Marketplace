...
<footer style="background: linear-gradient(90deg, #14532d 0%, #a16207 50%, #7c2d12 100%); color: #fff; padding: 3em 0 2em 0; margin-top: 3em; box-shadow: 0 -4px 32px #0004;">
  <div style="max-width: 1200px; margin: 0 auto; padding: 0 1.5em;">
    <div style="display: flex; flex-direction: column; gap: 2.5em;">
      <div style="display: flex; flex-direction: column; gap: 1.5em;">
        <div style="max-width: 340px;">
          <h3 style="font-size: 2em; font-weight: 800; margin-bottom: 0.5em; letter-spacing: 1px;">Vist Oromo Artisan & Storyteller Marketplace</h3>
          <p style="color: #fcd34d; margin-bottom: 1em;">Preserving Oromia's beautiful cultural heritage through fair trade</p>
          <div style="display: flex; gap: 1.2em; margin-top: 0.5em;">
            <a href="#" style="color: #fcd34d; font-size: 1.4em; text-decoration: none; transition: color 0.2s;" onmouseover="this.style.color='#fff'" onmouseout="this.style.color='#fcd34d'">&#x1F426;</a>
            <a href="#" style="color: #fcd34d; font-size: 1.4em; text-decoration: none; transition: color 0.2s;" onmouseover="this.style.color='#fff'" onmouseout="this.style.color='#fcd34d'">&#x1F4F7;</a>
            <a href="#" style="color: #fcd34d; font-size: 1.4em; text-decoration: none; transition: color 0.2s;" onmouseover="this.style.color='#fff'" onmouseout="this.style.color='#fcd34d'">&#x1F4F1;</a>
          </div>
        </div>
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(180px, 1fr)); gap: 2em; width: 100%;">
          <div>
            <h4 style="font-weight: 600; margin-bottom: 1em; color: #fcd34d;">Support</h4>
            <ul style="list-style: none; padding: 0; margin: 0;">
              <li><a href="#" style="color: #d1d5db; text-decoration: none; transition: color 0.2s;" onmouseover="this.style.color='#fcd34d'" onmouseout="this.style.color='#d1d5db'">Contact Artisan</a></li>
              <li><a href="#" style="color: #d1d5db; text-decoration: none; transition: color 0.2s;" onmouseover="this.style.color='#fcd34d'" onmouseout="this.style.color='#d1d5db'">Shipping Info</a></li>
              <li><a href="#" style="color: #d1d5db; text-decoration: none; transition: color 0.2s;" onmouseover="this.style.color='#fcd34d'" onmouseout="this.style.color='#d1d5db'">Returns</a></li>
            </ul>
          </div>
          <div>
            <h4 style="font-weight: 600; margin-bottom: 1em; color: #fcd34d;">About</h4>
            <ul style="list-style: none; padding: 0; margin: 0;">
              <li><a href="#" style="color: #d1d5db; text-decoration: none; transition: color 0.2s;" onmouseover="this.style.color='#fcd34d'" onmouseout="this.style.color='#d1d5db'">Our Mission</a></li>
              <li><a href="#" style="color: #d1d5db; text-decoration: none; transition: color 0.2s;" onmouseover="this.style.color='#fcd34d'" onmouseout="this.style.color='#d1d5db'">Cultural Preservation</a></li>
              <li><a href="#" style="color: #d1d5db; text-decoration: none; transition: color 0.2s;" onmouseover="this.style.color='#fcd34d'" onmouseout="this.style.color='#d1d5db'">Fair Trade Promise</a></li>
            </ul>
          </div>
          <div>
            <h4 style="font-weight: 600; margin-bottom: 1em; color: #fcd34d;">Newsletter</h4>
            <form style="display: flex; flex-direction: column; gap: 0.7em;">
              <input type="email" placeholder="Your email"
                style="padding: 0.7em 1em; border-radius: 0.5em; background: #1f2937; color: #fff; border: none; outline: none; font-size: 1em;" />
              <button type="submit"
                style="background: #fcd34d; color: #7c2d12; font-weight: 600; border: none; border-radius: 0.5em; padding: 0.7em 1em; cursor: pointer; transition: background 0.2s;"
                onmouseover="this.style.background='#fde68a'" onmouseout="this.style.background='#fcd34d'">Subscribe</button>
            </form>
          </div>
        </div>
      </div>
    </div>
    <div style="border-top: 1px solid #a16207; margin-top: 2.5em; padding-top: 1.5em; text-align: center; color: #d1d5db; font-size: 1em;">
