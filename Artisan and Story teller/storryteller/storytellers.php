    ...
    <main class="container mx-auto px-4 py-8">
        ...
        <div class="bg-white rounded-xl shadow p-6 mb-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <a href="add_story.php" class="border-2 border-dashed border-gray-200 hover:border-blue-300 rounded-lg p-5 text-center transition-colors">
                ...
                <a href="events.php" class="border-2 border-dashed border-gray-200 hover:border-blue-300 rounded-lg p-5 text-center transition-colors">
